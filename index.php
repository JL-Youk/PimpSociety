...
<!-- menu -->
 ...
 <div id="particles-js" style="min-height: 400px;" >
   <div class="panel" style="display: block;">
     <div class="container">
       <div class="section" >
         <div class="row" >
           <h1 class="col s12 light center header">P/50E13TY;</h1>
 ...
 <div class="parallax-container">
  ...
  <div class="section white" id="Offres">
    <div class="container">
      ...
      <div class="row Reveallext left-align">
        <div class="col l2 s4 center offset-l5">
            <i class="material-icons icon_realisations">message</i>
        </div>
        <div class="col l5 s8">
          <h5>Contact</h5>
          <p>
...
<div class="parallax-container">
 ...
 <footer class="page-footer grey darken-4" id="social">
        <div class="container">
          <div class="row">
